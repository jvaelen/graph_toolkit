...
#include "../src/observer/GUI/toolswidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ToolsWidget_t, stringdata) + ofs \
...
const QMetaObject ToolsWidget::staticMetaObject = {
    { &QToolBar::staticMetaObject, qt_meta_stringdata_ToolsWidget.data,
      qt_meta_data_ToolsWidget,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ToolsWidget.stringdata))
        return static_cast<void*>(const_cast< ToolsWidget*>(this));
    if (!strcmp(_clname, "Observer"))
        return static_cast< Observer*>(const_cast< ToolsWidget*>(this));
